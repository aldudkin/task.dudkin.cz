...
| ECS EC2| Per-service autoscaling, Hlavní zdroj logů, Možnost rezervovat compute předem se slevou a použivat spot instance pro fault-tolerating workloady| Optimální volba pro prod z hlediska ceny |
| ECS Fargate| Per-service autoscaling, Hlavní zdroj logů, žádná správa nodů (Fargate) | Optimální volba pro PoC |

Příklad výpočtů ceny compute time
...
| Položka | Výpočet | Cena/měs |
|---|---|---|
| On-Demand price | 1 instances x 0.0978 USD On Demand hourly cost x 730 hours in a month | 71.394000 USD |
| EBS storage | 20 GB x 1.00 instance months x 0.0952 USD | 1.90 USD USD |
| **Celkem** | | **73,294 USD** |

Výpočet nezhrnuje EC2 Instance Savings Plans, které nabízejí větší slevy na compute time, než Compute Savings Plans pro Fargate - použití EC2 backendů pro trválou zátěž z hlediska ceny dává větší smysl.
